...
function HoneymoonPackagesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.72 0.2 35) 0%, oklch(0.65 0.22 22) 40%, oklch(0.60 0.20 358) 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                backgroundImage: "url('https://images.unsplash.com/photo-1445019980597-93fa8acb246c?auto=format&fit=crop&w=1600&q=80')",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "linear-gradient(135deg, oklch(0.72 0.2 35 / 0.88) 0%, oklch(0.60 0.20 358 / 0.82) 100%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-5xl md:text-7xl font-bold mb-6 leading-tight", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      style: {
                        background: "linear-gradient(90deg, oklch(0.95 0.15 75), oklch(0.90 0.10 358))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-lg leading-relaxed mb-8", children: "Begin your forever with a journey to remember. Our handcrafted honeymoon packages are designed to create magical moments, intimate experiences, and lifelong memories for you and your beloved." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    size: "lg",
                    ...
                    onClick: () => {
                      var _a;
                      return (_a = document.getElementById("enquiry")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
                    },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            style: {
              background: "linear-gradient(90deg, oklch(0.65 0.22 22), oklch(0.60 0.20 358))",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent"
            },
            children: "Romantic Destinations"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: "Curated escapes for every kind of love story." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: destinations.map((dest, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden h-60", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: dest.image,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "absolute inset-0",
                      style: {
                        background: "linear-gradient(to top, oklch(0.20 0.15 22 / 0.95) 0%, oklch(0.45 0.18 35 / 0.5) 50%, transparent 100%)"
                      }
                    }
                  ),
                  dest.isNew && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 left-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-display text-2xl font-bold", children: dest.name }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-sm italic", children: dest.tagline })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 bg-card flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: dest.nights }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#enquiry", children: "Enquire" })
                    }
                  )
                ] })
              ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(135deg, oklch(0.98 0.01 358) 0%, oklch(0.97 0.01 30) 100%)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl font-bold mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                style: {
                  background: "linear-gradient(90deg, oklch(0.65 0.22 22), oklch(0.55 0.18 300))",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent"
                },
                children: "Why Choose Us for Your Honeymoon?"
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg", children: "Every package comes with special touches to make your honeymoon truly magical." })
          ] }),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.97 0.03 358), oklch(0.95 0.05 30))"
                    },
                    children: f.icon
                  }
                ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "enquiry", className: "py-16 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: "Plan Your Dream Honeymoon"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Fill in the form below and our honeymoon specialists will call you back." })
      ] }),
      submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          style: {
            background: "linear-gradient(135deg, oklch(0.65 0.22 22), oklch(0.60 0.20 358))"
          },
          "data-ocid": "honeymoon.success_state",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-5xl block mb-4", children: "💖" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-bold mb-2", children: "Enquiry Received!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85", children: "Our honeymoon specialist will contact you within 24 hours." }),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-name", children: "Your Name *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "hm-name",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-email", children: "Email Address *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "hm-email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-phone", children: "Phone Number *" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "hm-phone",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-dest", children: "Preferred Destination" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "hm-dest",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 sm:col-span-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-date", children: "Travel Date" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "hm-date",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "hm-message", children: "Special Requests" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Textarea,
                {
                  id: "hm-message",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Or call us directly:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(90deg, oklch(0.97 0.01 358), oklch(0.97 0.01 30))"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
...
export {
  HoneymoonPackagesPage as default
};
